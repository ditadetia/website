			...
			<div class="main-page">
				<div class="panel-head">
					<ol class="breadcrumb">
						...
						<li class="active">Media Partner</li>
					</ol>
				</div>
				<form action="proses_upload_mediapartner.php" enctype="multipart/form-data" method="post" name="form" onsubmit="return(validasi());">
				...
				if($sql->num_rows > 0) {
					$no = 1;
						...
						echo '<table style="float:left; margin-left:45px; margin-top:45px; margin-bottom:45px;" >
									...
									<tr>
									<td align="center">
									<form action = "hapus_image_mediapartner.php" method = "GET">
