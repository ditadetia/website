	  ...
	  <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<?php
				include "../config.php";
				$sql = $conn->query("SELECT * FROM tblartikel ORDER BY id");
				if($sql->num_rows > 0) {
					$no = 1;
				...
				<div class="col-md-12">
					...
					<div class="col-md-9">
						...
						<p>
							<?php
							echo "<form action = 'edit_artikel.php' method = 'GET'>
										<input type = 'hidden' name = 'id' value = '".$data['id']."'>
										<input type = 'submit' name = 'tombol' value = 'Edit' class = 'edit'>
										</form>";
							echo "<form action = 'hapus_artikel.php' method = 'GET'>
										<input type = 'hidden' name = 'id' value = '".$data['id']."'>
				...
				<hr>
					<h2>Add Articles</h2>
						<form action="submit.php" method="post" enctype="multipart/form-data" name="posting_form" onsubmit="return(validasi());">
						<br>
