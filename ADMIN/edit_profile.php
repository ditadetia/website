...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		include ("../config.php");
		$id 		= $_GET['id'];
		$sql 		= $conn->query("SELECT * FROM tim WHERE id='$id'");
			...
			<div class="main-page">
				<div class="panel-head">
						<ol class="breadcrumb">
							...
							<li><?php echo "<a href='detail.php?id=$id'>Detail</a>"; ?></li>
							<li class="active">Edit</li>
						</ol>
				</div>
				<div class="grid_3 widget-shadow">
					<form method='post' name='posting_form' enctype='multipart/form-data' action='update_profile.php'>
  				Name<br>
						<input type = 'hidden' name = 'id' value = '<?php echo $data['id'];?>'>
  					<input type='text' name='nama' value= '<?php echo $data['nama'];?>' size='50'><br><br>
					Email<br>
  					<input type='text' name='email' value= '<?php echo $data['email'];?>' size='50'><br><br>
  				Description<br>
  					<textarea name='deskripsi'  cols='50' rows='7'><?php echo $data['deskripsi'];?></textarea><br>
					Choose Image : <br/>
						<input type='file' name='filegbr' id='Filegambar'><br>
						<input type='submit' name='update_profil' value='Save Changes'>
					</form><br>
					<?php echo "<a href = 'detail.php?id=$id'> BACK </a>"; ?>
				</div>
			</div>
			<div class="clearfix"> </div>
		</div>
