...
<script src="js/wow.min.js"></script>
	...
	<script type="text/javascript">
		function validasi() {
			if(document.posting_form.judul.value == "")
			 {
			 alert( "Masukkan Judul Berita!" );
			 document.posting_form.judul.focus() ;
			 return false;
			 }

			 if(document.posting_form.isi.value == "")
			 {
			 alert( "Masukkan Isi Berita!" );
			 document.posting_form.isi.focus() ;
			 return false;
			 }

			 if(document.posting_form.filegbr.value == "")
			 {
			 alert( "Masukkan Foto Berita!" );
			 document.posting_form.filegbr.focus() ;
			 return false;
			 }
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<?php
				include "../config.php";
				$sql = $conn->query("SELECT * FROM tbl_berita ORDER BY id");
				if($sql->num_rows > 0) {
					$no = 1;
				...
				<div class="col-md-12">
					<div class="col-md-3">
						<?php echo '<img src="../'.$data['gambar'].'" width="180" height="180">'; ?>
					</div>
					<div class="col-md-9">
						<h3><?php echo $data['judul']; ?></h3>
						<p><?php echo $data['isi']; ?></p>
						<p class="btn btn-primary">Diposkan pada <?php echo date('j, F Y',strtotime($data['tanggal'])) ?> </p>
						<br><br/>
						<p>
							<?php
							echo "<form action = 'edit_news.php' method = 'GET'>
										<input type = 'hidden' name = 'id' value = '".$data['id']."'>
										<input type = 'submit' name = 'tombol' value = 'Edit' class = 'edit'>
										</form>";
							echo "<form action = 'hapus_news.php' method = 'GET'>
										<input type = 'hidden' name = 'id' value = '".$data['id']."'>
				...
				<hr>
					<h2>Add News</h2>
						<form action="simpanBerita.php" method="post" enctype="multipart/form-data" name="posting_form" onsubmit="return(validasi());">
						<br>
