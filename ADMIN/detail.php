      ...
      $data = $sql->fetch_array();
        ...
        $nama_image   = $data['nama_image'];
			...
			<div class="grid_3 widget-shadow">
				<table class="table">
					<tr>
						<th>NAME</th><th>:</th><td><?php echo $data['nama']; ?></td>
						<td>
							<?php
							echo "<form action = 'edit_profile.php' method = 'GET' style='float:right;'>
						...
						<td>
							<?php
							echo "<form action = 'hapus_profil.php' method = 'GET'>
										<input type = 'hidden' name = 'nama' value = '".$data['nama']."'>
										<input type = 'hidden' name = 'id' value = '".$data['id']."'>
										<input type = 'submit' name = 'tombol2' value = 'Delete Profile' class = 'delete'
				...
				<tr>
					<th>DESCRIPTION</th><th>:</th><td><?php echo $data['deskripsi']; ?></td>
				</tr>
  			<tr>
					<th>IMAGE</th><th>:</th><td><?php echo "<img src='tim/$nama_image' width='180' height='240' >"; ?></td>
				</tr>
			</table>
...
<div class="clearfix"> </div>
	<!--footer-->
		<div class="footer">
		   <p style="float:right; margin-bottom:15px; margin-right:20px;"> RETECH SOLUTION @ 2019 </p>
		</div>
  <!--//footer-->
	<!-- Classie -->
