			...
			<div class="main-page">
				<div class="panel-head">
					<ol class="breadcrumb">
						...
						<li><a href="wedo.php">Service</a></li>
				...
				include ("../config.php");
				$id 		= $_GET['id'];
				$sql 		= $conn->query("SELECT * FROM wedo WHERE id='$id'");
				$data 	= $sql->fetch_array();
					$bidang = $data['bidang'];
					$isi 		= $data['isi'];
				?>
				<div class="col-md-10">
					<form method='post' name='posting_form' action='update_wedo.php'>
					Practice<br>
						<input type = 'hidden' name = 'id' value = '<?php echo $data['id'];?>'>
						<input type='text' name='bidang'  size='50' value= '<?php echo $data['bidang']; ?>'><br><br>
					Content<br>
						<textarea name="isi" cols='50' rows='7' tabindex='4'><?php echo $data['isi']; ?></textarea><br>
						<input type='submit' name='update_wedo' value='Save Changes'>
					</form><br>
					<a href = 'wedo.php'> BACK </a>
				</div>
			</div>
			<div class="clearfix"> </div>
		</div>
