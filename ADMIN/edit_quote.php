	  ...
	  <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				include ("../config.php");
				$id 		= $_GET['id'];
				$sql 		= $conn->query("SELECT * FROM quote WHERE id='$id'");
				$data 	= $sql->fetch_array();
					$kalimat = $data['kalimat'];
				?>
				<div class="col-md-10">
					<form method='post' name='posting_form' enctype='multipart/form-data' action='update_quote.php'>
					Quote<br>
						<input type = 'hidden' name = 'id' value = '<?php echo $data['id'];?>'>
						<textarea name="kalimat" cols='60' rows='5' tabindex='4'><?php echo $data['kalimat']; ?></textarea><br>
					Choose Image : <br/>
						<input type='file' name='filegbr' id='Filegambar'><br>
						<input type='submit' name='update_quote' value='Save Changes'>
					</form><br>
