	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				include ("../config.php");
				$id 		= $_GET['id'];
				$sql 		= $conn->query("SELECT * FROM footer WHERE id='$id'");
				$data 	= $sql->fetch_array();
					$kategori = $data['kategori'];
					$isi 			= $data['isi'];
				?>
				<div class="col-md-10">
					<form method='post' name='posting_form' action='update_contact.php'>
					CATEGORY<br>
						<input type = 'hidden' name = 'id' value = '<?php echo $data['id'];?>'>
						<input type='text' name='kategori'  size='40' value= '<?php echo $data['kategori']; ?>'><br><br>
					CONTENT<br>
						<textarea name="isi" cols='40' rows='5' tabindex='4'><?php echo $data['isi']; ?></textarea><br>
						<input type='submit' name='update_contact' value='Save Changes'>
					</form><br>
