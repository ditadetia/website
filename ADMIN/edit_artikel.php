	  ...
	  <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				?>
				<div class="col-md-10">
					<form method='post' name='posting_form' action='update_artikel.php' enctype='multipart/form-data'>
					Title<br>
						<input type = 'hidden' name = 'id' value = '<?php echo $data['id']; ?>'>
						<input type='text' name='judul'  size='50' value= '<?php echo $data['judul']; ?>'><br><br>
					Content<br>
						<textarea name="isi" cols='70' rows='5' tabindex='4'><?php echo $data['isi']; ?></textarea><br><br>
					Choose Image<br>
						<input type='file' name='filegbr' id='Filegambar'><br>
						<input type='submit' name='update_artikel' value='Save Changes'>
					</form><br>
					<a href = 'artikel.php'> BACK </a>
				</div>
			</div>
			<div class="clearfix"> </div>
		</div>
