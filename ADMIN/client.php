	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<form action="proses_upload_client.php" enctype="multipart/form-data" method="post" name="form" onsubmit="return(validasi());">
				...
				if($sql->num_rows > 0) {
					$no = 1;
						...
						echo '<table style="float:left; margin-left:45px; margin-top:45px; margin-bottom:45px;" >
									...
									<tr>
									<td align="center">
									<form action = "hapus_image_client.php" method = "GET">
