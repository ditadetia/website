...
<body>
	...
	<div class="header-top">
		<div class="container">
			<div class="head-main">
				<h1><a href="index.html"><img src="images/favicon.png" width="80" height="80" alt=" " class="img-responsive" /></a></h1>
			</div>
			<div class="hea-rgt">
...
<div class="resource">
	<div class="container">
		...
		<div class="res-top">
			<div class="col-md-10">
				<h8><?php echo $data['judul']; ?></h8>
					<p style="font-style:italic;"><?php echo date('j F Y',strtotime($data['tanggal'])) ?></p>
					<br>
					<p><center>
					<?php echo '<img src="ADMIN/gambar/'.$data['gambar'].'" width="240" height="180">'; ?>
					</center></p>
					<br>
					<p><?php echo $data['isi']; ?></p>
					<a class="hvr-shutter-in-horizontal" href="news.php">BACK</a>
			</div>
			<div class="clearfix"></div>
		</div>
		</div>
		...
		<br><br>
			...
			<?php
			include "det2.php";
			$sql = $conn->query("SELECT * FROM tbl_berita ORDER BY RAND () LIMIT 0,5");
			if($sql->num_rows > 0) {
				$no = 1;
					...
					$judul	= $data['judul'];
						echo "<ul>
									<li><a href='newsdetail.php?id=$id'><span></span>$judul</a></li>
									</ul>";
				 		}
					}
			?>
			<br>
			<a href="news.php">>> Other News</a>
		</div>
