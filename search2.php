		...
		<h7><center>News</center></h7>
			...
			<div class="col-md-8 resource-lft">
	 		...
	 		if (isset($_POST['search'])) {
		 		$id					= $data['id'];
				$kata_kunci	= $_POST['pro_cari2'];
				$sql				= $conn->query("SELECT * FROM tbl_berita WHERE judul like '%$kata_kunci%' or isi like '%$kata_kunci%' ORDER BY id ASC");
				if($sql->num_rows > 0) {
				$no = 1;
			...
			<div class="res-top">
				<div class="col-md-10">
					<?php echo '<img src="ADMIN/gambar/'.$data['gambar'].'" width="180" height="180">'; ?>
						<h4><?php echo "<a href='newsdetail.php?id=$id'>".$data["judul"]."</a>"; ?></h4>
