	...
	<div class="practice">
		<div class="container">
			<div class="col-md-3 practice-left">
				<ul>
					<li style="margin-top:108px"><a href="produk.php"><span></span>Produk</a></li>
					<li class="active"><a href="jasa.php"><span></span>Jasa</a></li>
				</ul>
		</div>
		<div class="col-md-8 practice-right">
		<center><h3 style="background:green; color:white;">Jasa</h3></center>
		<div class="row"></div>
      ...
      $sql 			= $conn->query("SELECT * FROM jasa");
      $data 		= $sql->num_rows;
      $pages 		= ceil($data/$halaman);
      $id				= $data['id'];
      $sql 			= $conn->query("SELECT * FROM jasa ORDER BY id LIMIT $mulai, $halaman")or die(mysql_error);
			if($sql->num_rows > 0) {
				$no = $mulai+1;
