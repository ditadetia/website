...
<div class="practice">
	<div class="container">
		<div class="pra-tp">
			<h3 class="agile_head">Vission & Mission</h3>
				<div class="col-md-12">
					<?php
					include "config.php";
					...
					?>
					<ul><li><p><?php echo $tentang ?></p></li></ul>
					<?php
						}
				 	}
					?>
...
<div class="services-bottom">
	<div class="container">
		<h3>A genuine understanding of our clients’ needs, values and priorities empowers us to deliver efficient legal assistance</h3>
	</div>
</div>
<!-- //services-bottom -->
<!-- team -->
	<div class="services">
		<div class="container">
			<h3 class="agile_head">Team</h3>
				<p class="w3_agile_para">Retech Solution Team</p><br><br>
				<?php
				include "config.php";
				...
				<div class="col-md-4 w3layouts_team_grid">
					<div class="w3l_team_grd">
						<?php echo "<img src='ADMIN/tim/$nama_image' width='350' height='370' >"; ?>
